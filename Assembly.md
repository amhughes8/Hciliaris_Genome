...
```
Now that we have all of the .hdf files from the inference step, we can collate the results with *medaka sequence* 
```
medaka sequence /work/gatins/hci_genome/processing/medaka/results_inference/*.hdf polished.assembly.fasta
```
